...
public class SteamVR_Teleporter : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip my_clip;
    [SerializeField] private Canvas my_canvas ;
    [SerializeField] private Text my_txt;
    private int count = 0;
	...
	void DoClick(object sender, ClickedEventArgs e)
	{
		if (teleportOnClick)
		{
			...
			if (hasGroundTarget)
			{
                ...
                //AudioClip my_clip = GetComponent<AudioClip>(); 
                ...
                if (!hitInfo.collider.CompareTag("wall")) {
                    ...
                    if (hitInfo.collider.CompareTag("coin")) {
                        ...
                        AudioSource my_au = GetComponent<AudioSource>();
                        my_au.PlayOneShot(my_clip);
                        //collectText.Text = "You got a coin!";
                        count++;
                        my_txt.text = "You got a coin! " + count;
